<template>
  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="flex items-center space-x-6">
          ...
          <Link :href="route('admin.courses.index')" class="nav-link">Kurslar</Link>
          <Link :href="route('admin.lessons.index')" class="nav-link">Dersler</Link>
          <Link :href="route('admin.students.index')" class="nav-link">Öğrenciler</Link>
        </div>
        ...
        <div class="flex items-center gap-3 relative">
          ...
          <div class="relative" ref="dropdownRef">
            ...
            >
              <span>{{ userStore.user.value?.name || 'Admin Kullanıcı' }}</span>
              <svg
    ...
    >
      © 2025 LaravelCourses — Admin Panel
    </footer>
  </div>
</template>
...
/* 🧠 Kullanıcı */
const page = usePage()
const inertiaUser = page.props.auth?.user || { name: 'Admin Kullanıcı' }
